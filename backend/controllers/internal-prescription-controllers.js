...
const countWaitingPrescriptions = async (req, res, next) => {
	let count = 0;
	try {
		count = await InternalPrescription.count({ status: 'waiting' });
	} catch (e) {
...
exports.countWaitingPrescriptions = countWaitingPrescriptions;
